...
public class ExecuteKvpIT {
    ...
    public void testExecuteKVPSynchronousLiteralDataReponseDoc() throws IOException {
        ...
        String getURL = ExecuteKvpIT.url
                + "?Service=WPS&Request=Execute&Version=1.0.0&Identifier=org.n52.wps.server.algorithm.test.DummyTestClass&DataInputs=LiteralInputData=seventy@datatype=xs%3Astring@uom=meter&ResponseDocument=LiteralOutputData";
    ...
    public void testExecuteKVPSynchronousLiteralDataRawData() throws IOException {
        ...
        String getURL = ExecuteKvpIT.url
                + "?Service=WPS&Request=Execute&Version=1.0.0&Identifier=org.n52.wps.server.algorithm.test.DummyTestClass&DataInputs=LiteralInputData=seventy@datatype=xs%3Astring@uom=meter&RawDataOutput=LiteralOutputData";
    ...
    public void testExecuteKVPSynchronousBBoxDataReponseDoc() throws IOException {
        ...
        String getURL = ExecuteKvpIT.url
                + "?Service=WPS&Request=Execute&Version=1.0.0&Identifier=org.n52.wps.server.algorithm.test.DummyTestClass&DataInputs=BBOXInputData=46,102,47,103,urn%3Aogc%3Adef%3Acrs%3AEPSG%3A6.6%3A4326,2&ResponseDocument=BBOXOutputData";
    ...
    public void testExecuteKVPSynchronousBBoxDataRawData() throws IOException {
        ...
        String getURL = ExecuteKvpIT.url
                + "?Service=WPS&Request=Execute&Version=1.0.0&Identifier=org.n52.wps.server.algorithm.test.DummyTestClass&DataInputs=BBOXInputData=46,102,47,103,urn%3Aogc%3Adef%3Acrs%3AEPSG%3A6.6%3A4326,2&RawDataOutput=BBOXOutputData";
    ...
    public void testExecuteKVPSynchronousComplexDataReferenceResponseDoc() throws IOException {
        ...
        String getURL = ExecuteKvpIT.url
                + "?Service=WPS&Request=Execute&Version=1.0.0&Identifier=org.n52.wps.server.algorithm.test.EchoProcess&DataInputs="
                + inputID + "=@href=" + referenceComplexXMLInputURLEncoded + "@mimeType=" + inputMimeType
                + "&ResponseDocument=" + outputID;
    ...
    public void testExecuteKVPSynchronousComplexDataReferenceResponseDocSchemaMimeType() throws IOException {
        ...
        String getURL = ExecuteKvpIT.url
                + "?Service=WPS&Request=Execute&Version=1.0.0&Identifier=org.n52.wps.server.algorithm.test.EchoProcess&DataInputs="
                + inputID + "=@href=" + referenceComplexXMLInputURLEncoded + "@mimeType=" + inputMimeType
                + "&ResponseDocument=" + outputID + "@mimeType=" + outputMimeType + "";
    ...
    public void testExecuteKVPSynchronousComplexDataReferenceResponseDocMimeTypeEncodingBase64() throws IOException {
        ...
        String getURL = ExecuteKvpIT.url
                + "?Service=WPS&Request=Execute&Version=1.0.0&Identifier=org.n52.wps.server.algorithm.test.MultiReferenceBinaryInputAlgorithm&DataInputs=data=@href="
                + referenceComplexBinaryInputURLEncoded + "@mimeType=image/tiff;data=@href="
                + referenceComplexBinaryInputURLEncoded
                + "@mimeType=image/tiff&ResponseDocument=result@mimeType=image/tiff@encoding=base64";
    ...
    public void testExecuteKVPSynchronousComplexDataReferenceRawData() throws IOException {
        ...
        String getURL = ExecuteKvpIT.url
                + "?Service=WPS&Request=Execute&Version=1.0.0&Identifier=org.n52.wps.server.algorithm.test.EchoProcess&DataInputs="
                + inputID + "=@href=" + referenceComplexXMLInputURLEncoded + "@mimeType=" + inputMimeType
                + "&RawDataOutput=" + outputID + "@mimeType=" + outputMimeType + "";
