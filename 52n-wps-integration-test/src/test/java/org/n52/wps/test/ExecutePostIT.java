...
public class ExecutePostIT {
    ...
    private final String multiReferenceBinaryInputAlgorithmReferenceComplexBinaryInput = AllTestsIT.getURL()
            + "/../testData/elev_srtm_30m21.tif";
    ...
    public static void beforeClass() throws XmlException, IOException {
        ...
        // WPSConfig.forceInitialization("src/main/webapp/config/wps_config.xml");//FIXME bpross-52n: I don't
    ...
    public void before() {
        ...
        try {
            echoProcessDescription = wpsClient.getProcessDescription(url, echoProcessIdentifier);
        ...
        try {
            multiReferenceBinaryInputAlgorithmDescription = wpsClient.getProcessDescription(url,
                                                                                            multiReferenceBinaryInputAlgorithmIdentifier);
    ...
    @Test
    public void testExecutePOSTInlineComplexXMLSynchronousXMLOutput() throws IOException,
            ParserConfigurationException,
            SAXException {
        System.out.println("\nRunning testExecutePOSTInlineComplexXMLSynchronousXMLOutput");

        try {
            echoProcessExecuteRequestBuilder.addComplexData(echoProcessComplexInputID,
                                                            echoProcessInlineComplexXMLInput,
                                                            null,
                                                            null,
                                                            echoProcessComplexMimeTypeTextXML);

            echoProcessExecuteRequestBuilder.setResponseDocument(echoProcessComplexOutputID,
                                                                 null,
                                                                 null,
                                                                 echoProcessComplexMimeTypeTextXML);

            Object responseObject = WPSClientSession.getInstance().execute(url,
                                                                           echoProcessExecuteRequestBuilder.getExecute());
    ...
    @Test
    public void testExecutePOSTreferenceComplexXMLSynchronousXMLOutput() throws IOException,
            ParserConfigurationException,
            SAXException {
        System.out.println("\nRunning testExecutePOSTreferenceComplexXMLSynchronousXMLOutput");

        try {
            echoProcessExecuteRequestBuilder.addComplexDataReference(echoProcessComplexInputID,
                                                                     echoProcessReferenceComplexXMLInput,
                                                                     null,
                                                                     null,
                                                                     echoProcessComplexMimeTypeTextXML);
    ...
    @Test
    public void testExecutePOSTreferencePOSTComplexXMLSynchronousXMLOutput() throws IOException,
            ParserConfigurationException,
            SAXException {
        ...
        echoProcessExecuteRequestBuilder.setRawData(echoProcessComplexOutputID,
                                                    null,
                                                    null,
                                                    echoProcessComplexMimeTypeTextXML);
        ...
        String payload = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
                ...
                + "	<wps:DataInputs>" + "		<wps:Input>" + "			<ows:Identifier>complexInput</ows:Identifier>"
                + "			<wps:Reference mimeType=\"text/xml\" xlink:href=\"" + AllTestsIT.getURL() + "\">"
                + "			<wps:Body>" + echoProcessExecuteRequestBuilder.getExecute().toString() + "			</wps:Body>"
                + "			</wps:Reference>" + "		</wps:Input>" + "	</wps:DataInputs>" + "	<wps:ResponseForm>"
                + "	<wps:ResponseDocument storeExecuteResponse=\"false\">" + "		<wps:Output asReference=\"false\">"
                + "			<ows:Identifier>complexOutput</ows:Identifier>" + "		</wps:Output>" + "	</wps:ResponseDocument>"
    ...
    @Test
    public void testExecutePOSTMultipleReferenceComplexXMLSynchronousXMLOutput() throws IOException,
            ParserConfigurationException,
            SAXException {
    ...
    private InputType createComplexInlineInput(String identifier,
                                               String value,
                                               String schema,
                                               String encoding,
                                               String mimeType) {
        ...
        try {
            ...
            throw new IllegalArgumentException("error inserting node into complexdata", e);
        }
    ...
    private Object createAndSubmitMultiReferenceBinaryInputAlgorithmExecuteWithResponseDocument(List<InputType> inputs,
                                                                                                boolean status,
        ...
        multiReferenceBinaryInputAlgorithmExecuteRequestBuilder.addComplexDataReference(multiReferenceBinaryInputAlgorithmComplexInputID,
                                                                                        multiReferenceBinaryInputAlgorithmReferenceComplexBinaryInput,
                                                                                        null,
                                                                                        null,
        ...
        multiReferenceBinaryInputAlgorithmExecuteRequestBuilder.setResponseDocument(multiReferenceBinaryInputAlgorithmComplexOutputID,
                                                                                    null,
                                                                                    "base64",
                                                                                    multiReferenceBinaryInputAlgorithmComplexMimeTypeImageTiff);

        multiReferenceBinaryInputAlgorithmExecuteRequestBuilder.setStoreSupport(multiReferenceBinaryInputAlgorithmComplexOutputID,
                                                                                storeSupport);
        multiReferenceBinaryInputAlgorithmExecuteRequestBuilder.setStatus(multiReferenceBinaryInputAlgorithmComplexOutputID,
                                                                          status);
        multiReferenceBinaryInputAlgorithmExecuteRequestBuilder.setAsReference(multiReferenceBinaryInputAlgorithmComplexOutputID,
                                                                               asReference);

        Object responseObject = WPSClientSession.getInstance().execute(url,
                                                                       multiReferenceBinaryInputAlgorithmExecuteRequestBuilder.getExecute());
    ...
    public void testExecutePOSTMultipleReferenceComplexBinarySynchronousBinaryOutput() throws IOException,
        ...
        try {
            ...
            Object responseObject = createAndSubmitMultiReferenceBinaryInputAlgorithmExecuteWithResponseDocument(false,
                                                                                                                 false,
                                                                                                                 false);
    ...
    @Test
    public void testExecutePOSTReferenceComplexXMLSynchronousXMLOutput_WFS_POST_MissingMimeType() throws IOException,
            ParserConfigurationException,
            SAXException {
        ...
        String payload = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
                ...
                + "	<ows:Identifier>org.n52.wps.server.algorithm.test.EchoProcess</ows:Identifier>"
                + "	<wps:DataInputs>" + "		<wps:Input>" + "			<ows:Identifier>complexInput</ows:Identifier>"
                + "			<wps:Reference xlink:href=\"" + AllTestsIT.getURL() + "\">" + "			<wps:Body>"
                + echoProcessExecuteRequestBuilder.getExecute().toString() + "			</wps:Body>" + "			</wps:Reference>"
    ...
    @Test
    public void testExecutePOSTInlineComplexBinaryASynchronousBinaryOutput() throws IOException,
            ParserConfigurationException,
            SAXException {
        ...
        String payload = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
                ...
                + "<wps:DataInputs>" + "<wps:Input>" + "<ows:Identifier>data</ows:Identifier>" + "<wps:Data>"
                + "<wps:ComplexData mimeType=\"image/tiff\" encoding=\"base64\">" + tiffImageBinaryInputAsBase64String
                + "</wps:ComplexData>" + "</wps:Data>" + "</wps:Input>" + "<wps:Input>"
                + "<ows:Identifier>data</ows:Identifier>" + "<wps:Data>"
                + "<wps:ComplexData mimeType=\"image/tiff\" encoding=\"base64\">" + tiffImageBinaryInputAsBase64String
                + "</wps:ComplexData>" + "</wps:Data>" + "</wps:Input>" + "</wps:DataInputs>" + "<wps:ResponseForm>"
                + "<wps:ResponseDocument status=\"true\" storeExecuteResponse=\"true\">"
                + "<wps:Output encoding=\"base64\" mimeType=\"image/tiff\">"
                + "<ows:Identifier>result</ows:Identifier>" + "</wps:Output>" + "</wps:ResponseDocument>"
                + "</wps:ResponseForm>" + "</wps:Execute>";
        String response = PostClient.sendRequest(url, payload);
    ...
    /* Complex binary Input by value */
    @Test
    public void testExecutePOSTInlineAndReferenceComplexBinaryASynchronousBinaryOutput() throws IOException,
            ParserConfigurationException,
            SAXException {
        ...
        String payload = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
                ...
                + "<wps:ComplexData mimeType=\"image/tiff\" encoding=\"base64\">" + tiffImageBinaryInputAsBase64String
                + "</wps:ComplexData>" + "</wps:Data>" + "</wps:Input>" + "<wps:Input>"
                + "<ows:Identifier>data</ows:Identifier>" + "<wps:Reference mimeType=\"image/tiff\" xlink:href=\""
                + multiReferenceBinaryInputAlgorithmReferenceComplexBinaryInput + "\">" + "</wps:Reference>"
                + "</wps:Input>" + "</wps:DataInputs>" + "<wps:ResponseForm>"
                + "<wps:ResponseDocument status=\"true\" storeExecuteResponse=\"true\">"
                + "<wps:Output encoding=\"base64\" mimeType=\"image/tiff\">"
                + "<ows:Identifier>result</ows:Identifier>" + "</wps:Output>" + "</wps:ResponseDocument>"
    ...
    @Test
    public void testExecutePOSTReferenceComplexBinaryASynchronousBinaryOutput() throws IOException,
            ParserConfigurationException,
            SAXException {
        ...
        String payload = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
                ...
                + "<wps:Reference mimeType=\"image/tiff\" xlink:href=\""
                + multiReferenceBinaryInputAlgorithmReferenceComplexBinaryInput + "\">" + "</wps:Reference>"
                + "</wps:Input>" + "<wps:Input>" + "<ows:Identifier>data</ows:Identifier>"
                + "<wps:Reference mimeType=\"image/tiff\" xlink:href=\""
                + multiReferenceBinaryInputAlgorithmReferenceComplexBinaryInput + "\">" + "</wps:Reference>"
                + "</wps:Input>" + "</wps:DataInputs>" + "<wps:ResponseForm>"
                + "<wps:ResponseDocument status=\"true\" storeExecuteResponse=\"true\">"
                + "<wps:Output encoding=\"base64\" >" + "<ows:Identifier>result</ows:Identifier>" + "</wps:Output>"
    ...
    @Test
    public void testExecutePOSTLiteralStringSynchronousXMLOutput() throws IOException,
            ParserConfigurationException,
            SAXException {
        ...
        try {
            // echoProcessExecuteRequestBuilder.addComplexDataReference(echoProcessComplexInputID,
            // echoProcessReferenceComplexXMLInput, null, null, echoProcessComplexMimeTypeTextXML);
    ...
    /* BBOX Input by value */
    @Test
    public void testExecutePOSTinlineBBOXDataInputTestSynchronousBBOXOutput() throws IOException,
            ParserConfigurationException,
            SAXException {
        ...
        String payload = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
                ...
                + "<wps:DataInputs>" + "<wps:Input>" + "<ows:Identifier>BBOXInputData</ows:Identifier>"
                + "<ows:Title>Distance which people will walk to get to a playground.</ows:Title>" + "<wps:Data>"
                + "<wps:BoundingBoxData crs=\"EPSG:4326\">" + "<ows:LowerCorner>46.75 13.05</ows:LowerCorner>"
                + "<ows:UpperCorner>46.85 13.25</ows:UpperCorner>" + "</wps:BoundingBoxData>" + "</wps:Data>"
                + "</wps:Input>" + "</wps:DataInputs>" + "<wps:ResponseForm>"
                + "<wps:ResponseDocument status=\"false\" storeExecuteResponse=\"false\">"
                + "<wps:Output asReference=\"false\">" + "<ows:Identifier>BBOXOutputData</ows:Identifier>"
    ...
    @Test
    public void testExecutePOSTinlineBBOXDataInputTestSynchronousBBOXOutputNoEPSG() throws IOException,
            ParserConfigurationException,
            SAXException {
        ...
        String payload = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
                ...
                + "<wps:DataInputs>" + "<wps:Input>" + "<ows:Identifier>BBOXInputData</ows:Identifier>"
                + "<ows:Title>Distance which people will walk to get to a playground.</ows:Title>" + "<wps:Data>"
                + "<wps:BoundingBoxData>" + "<ows:LowerCorner>46.75 13.05</ows:LowerCorner>"
                + "<ows:UpperCorner>46.85 13.25</ows:UpperCorner>" + "</wps:BoundingBoxData>" + "</wps:Data>"
                + "</wps:Input>" + "</wps:DataInputs>" + "<wps:ResponseForm>"
                + "<wps:ResponseDocument status=\"false\" storeExecuteResponse=\"false\">"
                + "<wps:Output asReference=\"false\">" + "<ows:Identifier>BBOXOutputData</ows:Identifier>"
    ...
    /*
     * Complex XML Output by value TODO: this could be checked with the
     * testExecutePOSTInlineComplexXMLSynchronousXMLOutput
     */
    @Test
    public void testExecutePOSTComplexXMLSynchronousXMLOutput() throws IOException,
            ParserConfigurationException,
            SAXException {
    ...
    @Test
    public void testExecutePOSTComplexXMLSynchronousXMLOutputByReference() throws IOException,
            ParserConfigurationException,
            SAXException {
    ...
    @Test
    public void testExecutePOSTComplexXMLASynchronousXMLOutputStoreStatusTrue() throws IOException,
            ParserConfigurationException,
            SAXException {
    ...
    @Test
    public void testExecutePOSTComplexXMLASynchronousXMLOutputStoreTrue() throws IOException,
            ParserConfigurationException,
            SAXException {
    ...
    @Test
    public void testExecutePOSTComplexXMLASynchronousXMLOutputReferenceStoreTrue() throws IOException,
            ParserConfigurationException,
            SAXException {
    ...
    @Test
    public void testExecutePOSTComplexXMLASynchronousXMLOutputByReferenceStatusStoreTrue() throws IOException,
            ParserConfigurationException,
            SAXException {
    ...
    @Test
    public void testExecutePOSTComplexXMLASynchronousRawXMLOutput() throws IOException,
            ParserConfigurationException,
            SAXException {
    ...
    @Test
    public void testExecutePOSTComplexBinaryASynchronousBinaryOutputStoreStatusReferenceTrueHasCorrectFilename() throws IOException,
            ParserConfigurationException,
            SAXException {
    ...
    @Test
    public void testExecutePOSTValueComplexBinarySynchronousBinaryOutputBase64() throws ParserConfigurationException,
            IOException,
            SAXException {
    ...
    @Test
    public void testExecutePOSTValueComplexBinarySynchronousBinaryOutputNoEncoding() throws IOException,
            ParserConfigurationException,
            SAXException {
    ...
    @Test
    public void testExecutePOSTValueComplexBinarySynchronousBinaryOutputStatusBase64() throws ParserConfigurationException,
            SAXException,
            IOException {
        ...
        try {
            ...
            Object responseObject = createAndSubmitMultiReferenceBinaryInputAlgorithmExecuteWithResponseDocument(true,
                                                                                                                 false,
                                                                                                                 false);
    ...
    @Test
    public void testExecutePOSTValueComplexBinarySynchronousBinaryOutputStatusNoEncoding() throws ParserConfigurationException,
            SAXException,
            IOException {
    ...
    @Test
    public void testExecutePOSTValueComplexBinarySynchronousBinaryOutputAsReferenceStatusBase64() throws IOException,
            ParserConfigurationException,
            SAXException {
    ...
    @Test
    public void testExecutePOSTValueComplexBinarySynchronousBinaryOutputAsReferenceStatusNoEncoding() throws IOException,
            ParserConfigurationException,
            SAXException {
    ...
    @Test
    public void testExecutePOSTValueComplexBinaryASynchronousBinaryOutputStoreBase64() throws IOException,
            ParserConfigurationException,
            SAXException {
    ...
    @Test
    public void testExecutePOSTValueComplexBinaryASynchronousBinaryOutputStoreNoEncoding() throws IOException,
            ParserConfigurationException,
            SAXException {
    ...
    @Test
    public void testExecutePOSTValueComplexBinaryASynchronousBinaryOutputStoreReferenceBase64() throws IOException,
            ParserConfigurationException,
            SAXException {
    ...
    @Test
    public void testExecutePOSTValueComplexBinaryASynchronousBinaryOutputStoreReferenceNoEncoding() throws IOException,
            ParserConfigurationException,
            SAXException {
    ...
    @Test
    public void testExecutePOSTValueComplexBinaryASynchronousBinaryOutputStoreStatusBase64() throws IOException,
            ParserConfigurationException,
            SAXException {
    ...
    @Test
    public void testExecutePOSTValueComplexBinaryASynchronousBinaryOutputStoreStatusNoEncoding() throws IOException,
            ParserConfigurationException,
            SAXException {
    ...
    @Test
    public void testExecutePOSTValueComplexBinaryASynchronousBinaryOutputRawBase64() throws IOException,
            ParserConfigurationException,
            SAXException {
    ...
    @Test
    public void testExecutePOSTValueComplexBinaryASynchronousBinaryOutputReferenceStoreStatusNoEncoding() throws IOException,
            ParserConfigurationException,
            SAXException {
    ...
    public void testExecutePOSTValueComplexBinarySynchronousBinaryOutputRawbase64() throws IOException {
        ...
        try {
            ...
            Object responseObject = createAndSubmitMultiReferenceBinaryInputAlgorithmExecuteWithRawData(true,
                                                                                                        true,
                                                                                                        true,
                                                                                                        "base64");
    ...
    public void testExecutePOSTinlineLiteralDataSynchronousLiteralOutput() throws IOException {
        ...
        String payload = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
                ...
                + "http://schemas.opengis.net/wps/1.0.0/wpsExecute_request.xsd\">"
                + "<ows:Identifier>org.n52.wps.server.algorithm.test.DummyTestClass</ows:Identifier>"
                + "<wps:DataInputs>" + "<wps:Input>" + "<ows:Identifier>LiteralInputData</ows:Identifier>"
                + "<ows:Title>Distance which people will walk to get to a playground.</ows:Title>" + "<wps:Data>"
                + "<wps:LiteralData>007</wps:LiteralData>" + "</wps:Data>" + "</wps:Input>" + "</wps:DataInputs>"
                + "<wps:ResponseForm>" + "<wps:ResponseDocument status=\"false\" storeExecuteResponse=\"false\">"
                + "<wps:Output asReference=\"false\">" + "<ows:Identifier>LiteralOutputData</ows:Identifier>"
                + "</wps:Output>" + "</wps:ResponseDocument>" + "</wps:ResponseForm>" + "</wps:Execute>";
        String response = PostClient.sendRequest(url, payload);
        assertThat(response, response, not(containsString("ExceptionReport")));
    ...
    public void testExecutePOSTinlineLiteralDataSynchronousLiteralOutputStatus() throws IOException {
        ...
        String payload = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
                ...
                + "<ows:Title>Distance which people will walk to get to a playground.</ows:Title>" + "<wps:Data>"
                + "<wps:LiteralData>007</wps:LiteralData>" + "</wps:Data>" + "</wps:Input>" + "</wps:DataInputs>"
                + "<wps:ResponseForm>" + "<wps:ResponseDocument status=\"true\" storeExecuteResponse=\"false\">"
                + "<wps:Output asReference=\"false\">" + "<ows:Identifier>LiteralOutputData</ows:Identifier>"
                + "</wps:Output>" + "</wps:ResponseDocument>" + "</wps:ResponseForm>" + "</wps:Execute>";
        String response = PostClient.sendRequest(url, payload);
        assertThat(response, response, not(containsString("ExceptionReport")));
    ...
    @Test
    public void testExecutePOSTinlineLiteralDataASynchronousLiteralOutputStoreStatus() throws IOException,
            ParserConfigurationException,
            SAXException {
        ...
        String payload = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
                ...
                + "<ows:Title>Distance which people will walk to get to a playground.</ows:Title>" + "<wps:Data>"
                + "<wps:LiteralData>007</wps:LiteralData>" + "</wps:Data>" + "</wps:Input>" + "</wps:DataInputs>"
                + "<wps:ResponseForm>" + "<wps:ResponseDocument status=\"true\" storeExecuteResponse=\"true\">"
                + "<wps:Output asReference=\"true\">" + "<ows:Identifier>LiteralOutputData</ows:Identifier>"
                + "</wps:Output>" + "</wps:ResponseDocument>" + "</wps:ResponseForm>" + "</wps:Execute>";
    ...
    @Test
    public void testExecutePOSTinlineLiteralDataASynchronousLiteralOutputStore() throws IOException,
            ParserConfigurationException,
            SAXException {
        ...
        String payload = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
                ...
                + "<ows:Title>Distance which people will walk to get to a playground.</ows:Title>" + "<wps:Data>"
                + "<wps:LiteralData>007</wps:LiteralData>" + "</wps:Data>" + "</wps:Input>" + "</wps:DataInputs>"
                + "<wps:ResponseForm>" + "<wps:ResponseDocument status=\"false\" storeExecuteResponse=\"true\">"
                + "<wps:Output asReference=\"false\">" + "<ows:Identifier>LiteralOutputData</ows:Identifier>"
                + "</wps:Output>" + "</wps:ResponseDocument>" + "</wps:ResponseForm>" + "</wps:Execute>";
        String response = PostClient.sendRequest(url, payload);
        assertThat(AllTestsIT.parseXML(response), is(not(nullValue())));
    ...
    public void testExecutePOSTinlineLiteralDataSynchronousLiteralOutputRaw() throws IOException {
        ...
        String payload = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
                ...
                + "<ows:Title>Distance which people will walk to get to a playground.</ows:Title>" + "<wps:Data>"
                + "<wps:LiteralData>007</wps:LiteralData>" + "</wps:Data>" + "</wps:Input>" + "</wps:DataInputs>"
                + "<wps:ResponseForm>" + "<wps:RawDataOutput>" + "<ows:Identifier>LiteralOutputData</ows:Identifier>"
    ...
    public void testExecutePOSTinlineLiteralDataSynchronousLiteralOutputUOM() throws IOException {
        ...
        String payload = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
                ...
                + "<wps:DataInputs>" + "<wps:Input>" + "<ows:Identifier>LiteralInputData</ows:Identifier>"
                + "<ows:Title>Distance which people will walk to get to a playground.</ows:Title>" + "<wps:Data>"
                + "<wps:LiteralData uom=\"m\">007</wps:LiteralData>" + "</wps:Data>" + "</wps:Input>"
    ...
    @Test
    public void testExecutePOSTinlineBBOXDataASynchronousBBOXOutputStore() throws IOException,
            ParserConfigurationException,
            SAXException {
    ...
    @Test
    public void testExecutePOSTinlineBBOXDataASynchronousBBOXOutputStoreStatus() throws IOException,
            ParserConfigurationException,
            SAXException {
    ...
    public void testExecutePOSTinlineBBOXDataSynchronousBBOXOutputRaw() throws IOException {
        ...
        String payload = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
                ...
                + "<ows:Identifier>BBOXOutputData</ows:Identifier>" + "</wps:RawDataOutput>" + "</wps:ResponseForm>"
                + "</wps:Execute>";
        String response = PostClient.sendRequest(url, payload);
        assertThat(response, response, not(containsString("ExceptionReport")));
        assertThat(response, response, not(containsString("Response")));
    ...
    @Test
    public void testExecutePOSTinlineBBOXDataASynchronousBBOXOutputStoreNoEPSG() throws IOException,
            ParserConfigurationException,
            SAXException {
    ...
    @Test
    public void testExecutePOSTinlineBBOXDataASynchronousBBOXOutputStoreStatusNoEPSG() throws IOException,
            ParserConfigurationException,
            SAXException {
    ...
    private Object createAndSubmitMultiReferenceBinaryInputAlgorithmExecuteWithResponseDocument(boolean status,
                                                                                                boolean storeSupport,
                                                                                                boolean asReference,
                                                                                                String outputEncoding) throws WPSClientException {
    ...
    private Object createAndSubmitMultiReferenceBinaryInputAlgorithmExecuteWithRawData(boolean status,
                                                                                       boolean storeSupport,
                                                                                       boolean asReference,
                                                                                       String encoding) throws WPSClientException {
        ...
        multiReferenceBinaryInputAlgorithmExecuteRequestBuilder.setRawData(multiReferenceBinaryInputAlgorithmComplexOutputID,
                                                                           null,
                                                                           encoding,
                                                                           multiReferenceBinaryInputAlgorithmComplexMimeTypeImageTiff);
    ...
    private Object createAndSubmitEchoProcessExecuteWithResponseDocument(boolean status,
                                                                         boolean storeSupport,
                                                                         boolean asReference) throws WPSClientException {
